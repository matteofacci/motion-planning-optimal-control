function plot_unicycle(x,y,theta,L,wheelWidth,wheelDiam,bodyDiam,radCaster)
...
arrowLength = bodyDiam/2; % diminuire o aumentare per regolare la lunghezza delle frecce nel grafico

angle = theta;
rho=arrowLength*ones(1,length(angle));
[a,b] = pol2cart(angle,rho);
quiver(x + bodyDiam/2*cos(theta), y + bodyDiam/2*sin(theta),a, b,0,'b','linewidth',1.5)
