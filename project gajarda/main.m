...
soglia(3)=2; % valore in metri della soglia di commutazione 3 (per u nullo)
...
K1 = 10000*10^-6; % Peso termine x
K2 = 10000*10^-6; % Peso termine y
K3 = 10000*10^-6; % Peso termine theta
...
while N>0
    ...
    U2min=U2inf*vettore;
    U2max=U2sup*vettore;
    LB=horzcat(U1min,U2min); % vettore di dimensione 3N
