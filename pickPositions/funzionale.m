...
global x0 y0 theta0 x1 y1 theta1 % condizioni iniziali
...
termine1=K1*sum((x-x1).^2); % ogni componente di x viene elevata a potenza e sommata
termine2=K2*sum((y-y1).^2);
...
termine3=K3*sum((theta-theta1).^2); 
